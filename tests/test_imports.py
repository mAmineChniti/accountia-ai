...
def test_import_services():
    ...
    # ModelManager removed; tiny analyzer remains
...
def test_import_db():
    ...
    from app.db.mongodb import close_mongodb, get_platform_db, get_tenant_db, init_mongodb
    from app.db.redis import close_redis, get_redis, init_redis
    from app.db.schemas import AccountingPeriod, AccountingTask, AccountingTaskStatus
